...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/label-helpers.js");
/* harmony import */ var victory_bar__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! victory-bar */ "../../victory-bar/es/helper-methods.js");
...
/* harmony import */ var d3_array__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! d3-array */ "../node_modules/d3-array/src/bin.js");
...
var dataOrBinsContainDates = function (_ref) {
  var data = _ref.data,
      bins = _ref.bins,
      x = _ref.x;
  var xAccessor = victory_core__WEBPACK_IMPORTED_MODULE_4__.createAccessor(x || "x");
...
var getBinningFunc = function (_ref2) {
  ...
  var xAccessor = victory_core__WEBPACK_IMPORTED_MODULE_4__.createAccessor(x || "x");
  var bin = d3_array__WEBPACK_IMPORTED_MODULE_5__.default().value(xAccessor);
  var niceScale = (dataOrBinsContainsDates ? d3_scale__WEBPACK_IMPORTED_MODULE_3__.scaleTime() : d3_scale__WEBPACK_IMPORTED_MODULE_3__.scaleLinear()).domain(d3_array__WEBPACK_IMPORTED_MODULE_6__.default(data, xAccessor)).nice();
...
var getData = function (props) {
  ...
  return victory_core__WEBPACK_IMPORTED_MODULE_7__.getData(_objectSpread({}, props, {
    data: formattedData,
    x: "x"
  }));
};
var getDomain = function (props, axis) {
  ...
  if (axis === "x") {
    ...
    return victory_core__WEBPACK_IMPORTED_MODULE_8__.getDomainWithZero(_objectSpread({}, props, {
      data: [{
        x: firstBin.x0
      }, {
        x: lastBin.x1
  ...
  return props.data.length ? victory_core__WEBPACK_IMPORTED_MODULE_8__.getDomainWithZero(_objectSpread({}, props, {
    data: data
  }), "y") : [0, 1];
};

var getCalculatedValues = function (props) {
  var defaultStyles = victory_core__WEBPACK_IMPORTED_MODULE_4__.getDefaultStyles(props, "histogram");
  ...
  var data = getData(props);
  data = victory_core__WEBPACK_IMPORTED_MODULE_7__.formatDataFromDomain(data, domain, 0);
  var scale = {
...
var getBaseProps = function (props, fallbackProps) {
  var modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_4__.modifyProps(props, fallbackProps, "histogram");
  ...
  return data.reduce(function (childProps, datum, index) {
    ...
    var _getBarPosition = (0,victory_bar__WEBPACK_IMPORTED_MODULE_10__.getBarPosition)(props, datum),
        x = _getBarPosition.x,
        y = _getBarPosition.y,
    ...
    var text = victory_core__WEBPACK_IMPORTED_MODULE_11__.getText(props, datum, index);

    if (text !== undefined && text !== null || labels && (events || sharedEvents)) {
      childProps[eventKey].labels = victory_core__WEBPACK_IMPORTED_MODULE_11__.getProps(props, index);
    }
...
/* harmony import */ var victory_bar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! victory-bar */ "../../victory-bar/es/bar.js");
...
Object.defineProperty(VictoryHistogram, "getFormattedData", {
  ...
  enumerable: true,
  writable: true,
  value: _helper_methods__WEBPACK_IMPORTED_MODULE_3__.getFormattedData
});
...
Object.defineProperty(VictoryHistogram, "defaultProps", {
  ...
  value: {
    ...
    data: defaultData,
    dataComponent: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_bar__WEBPACK_IMPORTED_MODULE_7__.default, null),
    groupComponent: react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", {
      role: "presentation"
    }),
    labelComponent: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.default, null),
    samples: 50,
    sortOrder: "ascending",
    standalone: true,
...
Object.defineProperty(VictoryHistogram, "getDomain", {
  ...
  enumerable: true,
  writable: true,
  value: _helper_methods__WEBPACK_IMPORTED_MODULE_3__.getDomain
});
Object.defineProperty(VictoryHistogram, "getData", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: _helper_methods__WEBPACK_IMPORTED_MODULE_3__.getData
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,victory_core__WEBPACK_IMPORTED_MODULE_10__.default)(VictoryHistogram));
...
/* harmony import */ var _range_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./range.js */ "../node_modules/d3-array/src/range.js");
/* harmony import */ var _ticks_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ticks.js */ "../node_modules/d3-array/src/ticks.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function histogram(data) {
    ...
    // Convert number of thresholds into uniform thresholds.
    if (!Array.isArray(tz)) {
      tz = (0,_ticks_js__WEBPACK_IMPORTED_MODULE_3__.tickStep)(x0, x1, tz);
      tz = (0,_range_js__WEBPACK_IMPORTED_MODULE_4__.default)(Math.ceil(x0 / tz) * tz, x1, tz); // exclusive
    }
