...
var voronoiContainerMixin = function (base) {
  ...
  function (_base) {
    ...
    _createClass(VictoryVoronoiContainer, [{
      ...
      value: function getTooltip(props) {
        ...
        if (Array.isArray(activePoints) && activePoints.length) {
          ...
          return showLabel ? react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(labelComponent, labelProps) : null;
        } else {
          return null;
        }
      ...
      value: function getChildren(props) {
        return _toConsumableArray(react__WEBPACK_IMPORTED_MODULE_4___default().Children.toArray(props.children)).concat([this.getTooltip(props)]);
      }
    }]);
    ...
    value: _objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_6__.default.defaultProps, {
      activateData: true,
      activateLabels: true,
      labelComponent: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_tooltip__WEBPACK_IMPORTED_MODULE_8__.default, null),
      voronoiPadding: 5
    })
...
Flyout.propTypes = _objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.primitiveProps, {
...
Flyout.defaultProps = {
  pathComponent: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.default, null),
  role: "presentation",
  shapeRendering: "auto"
};
...
function (_React$Component) {
  ...
  _createClass(VictoryTooltip, [{
    ...
    value: function getEvaluatedProps(props) {
      ...
      var _getStyles = this.getStyles(lodash_assign__WEBPACK_IMPORTED_MODULE_4___default()({}, props, {
        active: active,
        text: text
      })),
      ...
      var _getDimensions = this.getDimensions(lodash_assign__WEBPACK_IMPORTED_MODULE_4___default()({}, props, {
        style: style,
        flyoutStyle: flyoutStyle,
        active: active,
        text: text,
    ...
    value: function renderTooltip(props) {
      ...
      if (!active) {
        return renderInPortal ? react__WEBPACK_IMPORTED_MODULE_5___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__.default, null, null) : null;
      }
      ...
      var children = [react__WEBPACK_IMPORTED_MODULE_5___default().cloneElement(flyoutComponent, this.getFlyoutProps(evaluatedProps, calculatedValues)), react__WEBPACK_IMPORTED_MODULE_5___default().cloneElement(labelComponent, this.getLabelProps(evaluatedProps, calculatedValues))];
      var tooltip = react__WEBPACK_IMPORTED_MODULE_5___default().cloneElement(groupComponent, {
        role: "presentation",
        transform: calculatedValues.transform
      }, children);
      return renderInPortal ? react__WEBPACK_IMPORTED_MODULE_5___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__.default, null, tooltip) : tooltip;
    }
  }, {
    key: "render",
    value: function render() {
...
Object.defineProperty(VictoryTooltip, "defaultProps", {
  ...
  value: {
    active: false,
    renderInPortal: true,
    labelComponent: react__WEBPACK_IMPORTED_MODULE_5___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_13__.default, null),
    flyoutComponent: react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_flyout__WEBPACK_IMPORTED_MODULE_14__.default, null),
    groupComponent: react__WEBPACK_IMPORTED_MODULE_5___default().createElement("g", null)
  }
});
