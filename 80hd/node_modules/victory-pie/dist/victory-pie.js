...
var getSlices = function (props, data) {
  ...
  var layoutFunction = d3_shape__WEBPACK_IMPORTED_MODULE_5__.default().sort(null).startAngle(victory_core__WEBPACK_IMPORTED_MODULE_6__.degreesToRadians(props.startAngle)).endAngle(victory_core__WEBPACK_IMPORTED_MODULE_6__.degreesToRadians(props.endAngle)).padAngle(victory_core__WEBPACK_IMPORTED_MODULE_6__.degreesToRadians(padAngle)).value(function (datum) {
    return datum._y;
  });
...
Slice.propTypes = _objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_7__.primitiveProps, {
...
/* harmony import */ var _slice__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./slice */ "./slice.js");
...
Object.defineProperty(VictoryPie, "propTypes", {
  ...
  value: {
    ...
    cornerRadius: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_3__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func)]),
    ...
    innerRadius: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_3__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func)]),
    ...
    labelRadius: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_3__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func)]),
    ...
    padAngle: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_3__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func)]),
    ...
    radius: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_3__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func)]),
    ...
    sortKey: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_1___default().func), victory_core__WEBPACK_IMPORTED_MODULE_3__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_3__.integer, victory_core__WEBPACK_IMPORTED_MODULE_3__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string), prop_types__WEBPACK_IMPORTED_MODULE_1___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_1___default().string))]),
    ...
    x: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_1___default().func), victory_core__WEBPACK_IMPORTED_MODULE_3__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_3__.integer, victory_core__WEBPACK_IMPORTED_MODULE_3__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string), prop_types__WEBPACK_IMPORTED_MODULE_1___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_1___default().string))]),
