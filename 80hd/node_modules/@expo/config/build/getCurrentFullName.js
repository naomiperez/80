...
exports.getAccountUsername = exports.getCurrentFullName = void 0;
 ...
 * @returns
 */
function getCurrentFullName(manifest) {
    const username = getAccountUsername(manifest);
    return `@${username}/${manifest.slug}`;
}
exports.getCurrentFullName = getCurrentFullName;
...
//# sourceMappingURL=getCurrentFullName.js.map