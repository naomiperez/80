...
export declare class CollectionReference<T = DocumentData> extends Query<T> {
    ...
    /** @hideconstructor */
    constructor(firestore: Firestore_2, converter: FirestoreDataConverter_2<T> | null, _path: ResourcePath);
...
export declare class DocumentSnapshot<T = DocumentData> extends DocumentSnapshot_2<T> {
    ...
    constructor(_firestore: Firestore, userDataWriter: AbstractUserDataWriter, key: DocumentKey, document: Document_2 | null, metadata: SnapshotMetadata, converter: UntypedFirestoreDataConverter<T> | null);
    /**
...
declare class DocumentSnapshot_2<T = DocumentData> {
    ...
    /** @hideconstructor protected */
    constructor(_firestore: Firestore_2, _userDataWriter: AbstractUserDataWriter, _key: DocumentKey, _document: Document_2 | null, _converter: UntypedFirestoreDataConverter<T> | null);
