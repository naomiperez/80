...
function registerFirestore(instance) {
    configureForFirebase(instance, (app, auth) => new Firestore(app, new Firestore$1(app, auth), new IndexedDbPersistenceProvider()));
