...
var databaseC96156d6 = require('./database-c96156d6-f0f0e10d.js');
...
var FieldPath = /** @class */ (function () {
    ...
    FieldPath.documentId = function () {
         ...
         * effect is the same.
         */
        return new FieldPath(databaseC96156d6.FieldPath$1.keyField().canonicalString());
    };
...
function registerFirestore(instance) {
    configureForFirebase(instance, function (app, auth) { return new databaseC96156d6.Firestore(app, new databaseC96156d6.Firestore$1(app, auth), new databaseC96156d6.IndexedDbPersistenceProvider()); });
