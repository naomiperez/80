...
function loadBundle(data) {
    return database20c17a45.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database20c17a45.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database20c17a45.Query(this, 
...
registerBundle(database20c17a45.Firestore);
