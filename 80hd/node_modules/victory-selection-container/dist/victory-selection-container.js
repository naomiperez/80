  ...
  getDatasets: function (props) {
    ...
    var iteratee = function (child, childName, parent) {
      ...
      if (!victory_core__WEBPACK_IMPORTED_MODULE_6__.isDataComponent(child) || lodash_includes__WEBPACK_IMPORTED_MODULE_0___default()(blacklist, childName)) {
        ...
        child = parent ? react__WEBPACK_IMPORTED_MODULE_5___default().cloneElement(child, parent.props) : child;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_objectSpread({}, SelectionHelpers, {
  ...
  function (_base) {
    ...
    _createClass(VictorySelectionContainer, [{
      ...
      value: function getRect(props) {
        ...
        return y2 && x2 && x1 && y1 ? react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(selectionComponent, {
      ...
      value: function getChildren(props) {
        return _toConsumableArray(react__WEBPACK_IMPORTED_MODULE_1___default().Children.toArray(props.children)).concat([this.getRect(props)]);
      }
    }]);
    ...
    enumerable: true,
    writable: true,
    value: _objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_2__.default.propTypes, {
    ...
    enumerable: true,
    writable: true,
    value: _objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_2__.default.defaultProps, {
      activateSelectedData: true,
      allowSelection: true,
      selectionComponent: react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_3__.default, null),
      selectionStyle: {
        stroke: "transparent",
        fill: "black",
        fillOpacity: 0.1
